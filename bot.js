...
bot.on('message', message => {                      
  if(!message.channel.guild) return;
     ...
     message.channel.sendFile('https://cdn.discordapp.com/attachments/611202373272076309/616212954022543365/Color.png').then(msg => {
   ...
   const embed = new Discord.RichEmbed() 
    ...
    .setDescription("**You got black color :art:**.")
...
let y1Filter = (reaction, user) => reaction.emoji.name === '❤' && user.id === message.author.id;
   ...
   const embed = new Discord.RichEmbed() 
    ...
    .setDescription("**You got red color :art:**.")
    .setFooter(message.author.tag , message.author.avatarURL)
...
let y2Filter = (reaction, user) => reaction.emoji.name === '💛' && user.id === message.author.id;
   ...
   const embed = new Discord.RichEmbed() 
    ...
    .setDescription("**You got yellow color :art:**.")
    .setFooter(message.author.tag , message.author.avatarURL)
...
let dgFilter = (reaction, user) => reaction.emoji.name === '💚' && user.id === message.author.id;
   ...
   const embed = new Discord.RichEmbed() 
    ...
    .setDescription("**You got green color :art:**.")
    .setFooter(message.author.tag , message.author.avatarURL)
...
let y6Filter = (reaction, user) => reaction.emoji.name === '❌' && user.id === message.author.id;
   ...
   const embed = new Discord.RichEmbed() 
    ...
    .setDescription("**Your color has been removed**.")
    .setFooter(message.author.tag , message.author.avatarURL)
